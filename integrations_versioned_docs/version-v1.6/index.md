...
In order for **Secured Signal API** to be compatible and integratable with a service, you still need to manually define [**Field Mappings**](/docs/configuration/field-mappings) and [**Message Templates**](/docs/configuration/message-template).
